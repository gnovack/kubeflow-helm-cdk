...
export class HelmRepositories {
    ...
    static readonly ISTIO: string = "https://istio-release.storage.googleapis.com/charts";
    static readonly SECRET_STORE_CSI_DRIVER = "https://kubernetes-sigs.github.io/secrets-store-csi-driver/charts";
}
